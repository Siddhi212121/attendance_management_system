...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        #image 2
        img1=Image.open(r"images\img1.webp")
        ...
        b1_1.place(x=200,y=300,width=220,height=40)
         ...
         # Detect Face button
        img5=Image.open(r"images\b2.jpg")
        ...
        b2_2=Button(bg_img,text="Detect Face",cursor="hand2",font=("times new roman",15,"bold"),bg="darkblue",fg="white")
        b2_2.place(x=500,y=300,width=220,height=40)

        # Attedance button
        
        img6=Image.open(r"images\b3.jpg")
        ...
        img7=Image.open(r"images\b4.jpg")
        ...
        img8=Image.open(r"images\b5.jpg")
        ...
        b5_5=Button(bg_img,text="Train",cursor="hand2",font=("times new roman",15,"bold"),bg="darkblue",fg="white")
        b5_5.place(x=200,y=580,width=220,height=40)

        # photos face images button
        ...
        b6_6=Button(bg_img,text="Face Photos",command=self.open_img,cursor="hand2",font=("times new roman",15,"bold"),bg="darkblue",fg="white")
        b6_6.place(x=500,y=580,width=220,height=40)

         # developer button
        
        img10=Image.open(r"images\b7.jpeg")
        ...
        img11=Image.open(r"images\b8.jpeg")
